...
public class Application {
	...
	private static final String TOPIC = "mailservice";
	...
	public static void main(String[] args) {
		...
		TopicSubscriptionBuilder subscriptionBuilder = client
				...
				.handler((externalTask, externalTaskService) -> {
					...
					createNotificationFromVariables(externalTask);
					try {
	...
	private static void createNotificationFromVariables(ExternalTask externalTask){
		try{
			content = externalTask.getVariable("content");
			recipient = externalTask.getVariable("recipient");
